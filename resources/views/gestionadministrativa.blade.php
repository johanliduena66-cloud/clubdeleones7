		...
		<div id="colorlib-main">
			<div class="colorlib-work">
				<div class="colorlib-narrow-content">
					<div class="row">
						<div class="col-md-6 col-md-offset-3 col-md-pull-3 animate-box" data-animate-effect="fadeInLeft">
							...
							<h2 class="colorlib-heading">Gestión Administrativa</h2>
						</div>
					</div>
					<!-- Card -->
				...
				<div class="colorlib-narrow-content">
						...
						<h2 class="colorlib-heading">Presidentes </h2>
						...
						<div class="col-md-8 animate-box" data-animate-effect="fadeInRight">
							...
							<div class="col-md-4 col-sm-6 animate-box" data-animate-effect="fadeInLeft">
								<div class="blog-entry">
									<img src="{{asset ('imagesp/'.$presidente->imagen)}}" class="img-responsive" alt="HTML5 Bootstrap Template by colorlib.com">

									<div class="desc">
										<span><small>{{$presidente->created_at}}</small></span>
										<h3><a href="blog.html">{{$presidente->ano}}</a></h3>
					...
					<div class="row">
						<div class="col-md-4 animate-box" data-animate-effect="fadeInLeft">
							<h2 class="colorlib-heading">ESTRUCTURA DEL CLUB </h2>
                          
                            	<div class="container">
			    					<object  class="about-img";" data="{{url('/')}}/plantilla/archivos/estructura.pdf" type="application/pdf">
			    					<embed src="{{url('/')}}/plantilla/archivos/estructura.pdf" type="application/pdf" />
			    					</object>
								</div>
                       	</div>
					</div>
