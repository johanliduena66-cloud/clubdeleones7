...
<div class="img-tit animate-box" data-animate-effect="fadeInLeft" style="background-image: url({{url('/')}}/plantilla/images/admi.png);">
					...
					<div class="row row-bottom-padded-md">
						<div class="col-md-4">
						  <div class="about-img animate-box" data-animate-effect="fadeInLeft" >
                            ...
                            <img src="{{url('/')}}/plantilla/images/vision.png" width="300"/></div>
						</div>
						<div class="col-md-6 animate-box" data-animate-effect="fadeInLeft">
						  <div class="about-desc">
								
							<h2 class="colorlib-heading">Visión</h2>
								<p>Para  el año 2022 el Club de leones de corozal será reconocido como una entidad  sólida y eficaz, para seguir brindando servicios de alta calidad a los  habitantes de Corozal y de poblaciones cercanas, guiados por principios éticos,  morales y sociales propios del Leonismo, celebrando alianzas estratégicas y  convenios con entidades públicas y privadas que comulguen con nuestra  filosofía, y contribuyendo la problemática social de las comunidades para hacer  de Corozal un mejor vivir</p>
</div>
