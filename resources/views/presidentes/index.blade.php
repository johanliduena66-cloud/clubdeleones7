...
<a href="presidentes/create" class="btn btn-primary mb-3">CREAR</a>

<div class="col-lg-14">
    <table id="presidentes" class="table table-striped table-bordered shadow-lg mt-4" style="width:100%">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="/presidentes/{{$presidente->id}}/edit" class="btn btn-info">Editar</a>
                    @csrf
                    @method('DELETE')
